...
<script language="javascript">
  ...
  function show() {
	  ...
	  document.forms[0].action="resultTeamReport.php";
  ...
  function pick(isTavling)
  {
		...
		document.forms[0].action="resultTeamReportSelect.php";
		document.forms[0].submit();
  }
...
<center>
	...
	<tr>
		<td>
		<button id="ShowBut" name="ShowBut" tabIndex="100" onClick="javascript:show();">Visa lag resultat</button>
		</td>
	</tr>
</table>
